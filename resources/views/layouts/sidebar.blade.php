@section('sidebar')
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            <li class="active"><a href="#"><i class="fa fa-fw fa-dashboard"></i> {{ trans('sidebar.dashboard') }} <span class="sr-only">(current)</span></a></li>
        ...
        <ul class="nav nav-sidebar">
            <li><a href=""><i class="fa fa-fw fa-users"></i> {{ trans('sidebar.list-people') }}</a></li>
